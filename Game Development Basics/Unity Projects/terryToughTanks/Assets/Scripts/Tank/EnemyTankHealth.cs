...
public class EnemyTankHealth : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        m_HealthBar.SetMaxHealth((int)m_StartingHealth);
        m_Dead = false;
    }
    ...
    public void TakeDamage(float amount)
    {
        ...
        m_HealthBar.SetHealth((int)m_CurrentHealth); // update health bar slider
    ...
    private void OnDeath()
    {
        ...
        // Turn the player tank and enemy tank off
