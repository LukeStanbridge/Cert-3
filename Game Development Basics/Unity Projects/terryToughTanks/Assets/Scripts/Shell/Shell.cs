...
public class Shell : MonoBehaviour
{
    ...
    // The time in seconds bfore the shell is removed
    ...
    private void OnCollisionEnter(Collision other)
    {
        ...
        if (targetRigidbody != null)
        {
            ...
            EnemyTankHealth enemyTargetHealth = targetRigidbody.GetComponent<EnemyTankHealth>();

            if (targetHealth != null)
            {
                // Calculate the amount of damagethe target should take based on it's distance from the shell.
                float damage = CalculateDamage(targetRigidbody.position);

                //Deal this damage to the trunk
            ...
            {
                float damage = CalculateDamage(targetRigidbody.position);
                enemyTargetHealth.TakeDamage(damage);
            }
        }
    ...
    private float CalculateDamage(Vector3 targetPosition)
    {
        ...
        // Calculate damage at this proportion of the maximum possible damage
